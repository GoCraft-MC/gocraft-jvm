...
public final class PlayerCommandEvent extends fr.gocraft.api.Event {

    /// The event name used in ABI dispatch and plugin subscriptions.
    public static final String TYPE = "player.command";
    ...
    public PlayerCommandEvent(java.util.List<fr.gocraft.api.Value> fields, fr.gocraft.api.EffectSink sink) {
    ...
    /// The {@code command} the event carries.
    ///
    /// @return the current value in this event's snapshot
    ...
    ///
    /// @param value the replacement for {@code command}
