...
public final class PlayerQuitEvent extends fr.gocraft.api.Event {

    /// The event name used in ABI dispatch and plugin subscriptions.
    public static final String TYPE = "player.quit";
    ...
    public PlayerQuitEvent(java.util.List<fr.gocraft.api.Value> fields, fr.gocraft.api.EffectSink sink) {
    ...
    /// The {@code reason} the event carries.
    ///
    /// @return the current value in this event's snapshot
